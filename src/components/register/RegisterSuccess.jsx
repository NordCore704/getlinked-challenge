...
const RegisterSuccess = ({ onClose }) => {
  return (
    <motion.div initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}} className="flex items-center justify-center bg-black bg-opacity-50 inset-0 w-screen  h-screen p-5 z-50 fixed top-0 left-0">
