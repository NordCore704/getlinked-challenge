...
const RegisterSuccess = ({ onClose }) => {
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="flex items-center justify-center bg-scheme-dark bg-opacity-70 inset-0 w-screen  h-screen p-5 z-50 fixed top-0 left-0"
    >
      <div className="border-scheme-violet border flex rounded-md p-5 lg:p-10 items-center justify-center gap-5 flex-col relative">
        ...
        <button
          className="w-full bg-gradient-to-r from-scheme-pink to-scheme-purple rounded-sm font-semibold p-2"
          onClick={onClose}
        >
          Back
        </button>
